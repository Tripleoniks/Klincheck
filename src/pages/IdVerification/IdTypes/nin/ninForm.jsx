             ...
             <form onSubmit={verify}>
                  <div className="container-fluid form_area">
                     <div className="row form_row">
                         ...
                         <div className="col-md-6 col-12 text-center "><input type="text" className="input_area" onChange={e => setFirstName(e.target.value)} placeholder="Candidate's Firstname"/> </div>
                    </div>
                        
                        <div className="row">
                        <div className="col-md-6 col-12 text-center "><input type="date" className="input_area" onChange={e => setDOB(e.target.value)} /> </div>
                        
                        <div className="col-md-6 col-12 text-center "> <input type="tel" className="input_area" value={ninValue} placeholder="National Identification No" maxLength="11" onChange={(e)=> setNinValue(e.target.value)} /> </div>
                         </div>
                         </div>
                         <div className="row">
