                ...
                <div className="row home-row">
                    ...
                    <div className="col-md-5" >
                        ...
                        <ul>
                            ...
                            <li> <Link to="/certificate"><i className="fa-solid fa-right-long"></i>  Verify Academic Certificate </Link></li>
                            <li> <Link to="/person"><i className="fa-solid fa-right-long"></i>  Verify a Person - <span id="Guarantor">Guarantor, Ref, etc</span></Link></li>
                            <li> <Link to="/criminal"><i className="fa-solid fa-right-long"></i>  Confirm a Person's Criminal Record  </Link></li>
